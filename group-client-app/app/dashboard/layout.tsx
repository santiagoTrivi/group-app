          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                {workspace_stored ? (
                  <span className="inline-flex items-center justify-center px-2 ms-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                    {workspace_stored.name}
                  </span>
                ) : (
                  <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                    Pro
                  </span>
                )}
              </a>
